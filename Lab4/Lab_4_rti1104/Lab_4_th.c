/************************ dSPACE target specific file *************************
   ...
   Include file .\Lab_4_rti1104\Lab_4_th.c :

   Task Configuration file for model : Lab_4

   RTI1104 7.9 (02-Nov-2017)/2.17
   21-Feb-2020 13:41:25
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Lab_4_rti1104\Lab_4_th.c is for ST).
# endif
