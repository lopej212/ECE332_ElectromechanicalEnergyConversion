/************************ dSPACE target specific file *************************
   ...
   Include file .\Lab6_OpenLoop_rti1104\Lab6_OpenLoop_th.c :

   Task Configuration file for model : Lab6_OpenLoop

   RTI1104 7.9 (02-Nov-2017)/2.17
   06-Mar-2020 12:55:20
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Lab6_OpenLoop_rti1104\Lab6_OpenLoop_th.c is for ST).
# endif
