/************************ dSPACE target specific file *************************
   ...
   Include file .\Lab_5_rti1104\Lab_5_th.c :

   Task Configuration file for model : Lab_5

   RTI1104 7.9 (02-Nov-2017)/2.17
   28-Feb-2020 13:40:01
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Lab_5_rti1104\Lab_5_th.c is for ST).
# endif
