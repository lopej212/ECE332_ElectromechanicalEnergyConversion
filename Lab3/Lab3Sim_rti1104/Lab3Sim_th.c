/************************ dSPACE target specific file *************************
   ...
   Include file .\Lab3Sim_rti1104\Lab3Sim_th.c :

   Task Configuration file for model : Lab3Sim

   RTI1104 7.9 (02-Nov-2017)/2.17
   07-Feb-2020 13:24:47
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Lab3Sim_rti1104\Lab3Sim_th.c is for ST).
# endif
