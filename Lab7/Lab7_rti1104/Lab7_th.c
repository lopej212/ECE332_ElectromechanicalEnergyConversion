/************************ dSPACE target specific file *************************
   ...
   Include file .\Lab7_rti1104\Lab7_th.c :

   Task Configuration file for model : Lab7

   RTI1104 7.9 (02-Nov-2017)/2.17
   13-Mar-2020 12:37:27
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Lab7_rti1104\Lab7_th.c is for ST).
# endif
