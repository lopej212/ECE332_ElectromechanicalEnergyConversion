/************************ dSPACE target specific file *************************
   ...
   Include file .\exp1_rti1104\exp1_th.c :

   Task Configuration file for model : exp1

   RTI1104 7.9 (02-Nov-2017)/2.17
   31-Jan-2020 13:11:58
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\exp1_rti1104\exp1_th.c is for ST).
# endif
