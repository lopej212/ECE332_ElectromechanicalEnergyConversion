/*********************** dSPACE target specific file *************************
   ...
   Include file Lab6_OpenLoop_rti.c:
...
#define RTB_STRUCTURE_NAME             Lab6_OpenLoop_B
#define RTP_STRUCTURE_NAME             Lab6_OpenLoop_P
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  Lab6_OpenLoop_B.SFunction1 = (real_T) ds1104_inc_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);

  /* dSPACE I/O Board DS1104 #1 Unit:ENC_POS Group:DPOS */
  Lab6_OpenLoop_B.SFunction2 = (real_T) ds1104_inc_delta_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);
}
